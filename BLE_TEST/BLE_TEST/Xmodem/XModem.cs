...
namespace XModem
{
    ...
    public class XModem
    {
        ...
        public XModem(IGattCharacteristic port, CircularBuffer<byte> bReceiveBuffer)
        {
            this.port = port;
            this.ReceivedBuffer = bReceiveBuffer;

            BLE_TEST.Search.ble.ServerCallBackEvent += Ble_ServerCallBackEvent;
        }
